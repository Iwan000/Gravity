#include "GravitySourceBlackHole.h"

#include "Components/PrimitiveComponent.h"

AGravitySourceBlackHole::AGravitySourceBlackHole()
{
	SourceType = EForceType::BlackHole;
}
...
FVector AGravitySourceBlackHole::CalculateContribution(UPrimitiveComponent* ReceiverComp, float DeltaTime) const
{
	...
	FVector Direction = SourceLocation - ReceiverLocation;
